...
export { configureErrorModal, describeErrorResponse, type PageflowErrorResponse, type ErrorModalMount } from '@pageflow/core'
...
export type { PageflowErrorModalProps } from './createPageflowApp'
